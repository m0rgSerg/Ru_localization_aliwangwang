...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modIndex = __webpack_require__(235);
	...
	window.__WPO && __WPO.setConfig({
	    ...
	    sample: 1000,
	    spmId: 'pcww9.0-syssubmsg', // spmId必须设置,如果没写默认值，会自动抓页面的spm
	    retCode: {}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sideTitleList = __webpack_require__(236);

	var _sideTitleList2 = _interopRequireDefault(_sideTitleList);

	var _msgContent = __webpack_require__(238);

	var _msgContent2 = _interopRequireDefault(_msgContent);
	...
	var Index = (function (_React$Component) {
	    ...
	    _createClass(Index, [{
	        ...
	        value: function events() {
	            ...
	            _aliImSdk2['default'].on('SystemSubscriptionMsgComeNotify', function (data) {
	                _this.getSysList();
	            });
	        }
	    }, {
	        ...
	        value: function getSysList() {
	            ...
	            _aliImSdk2['default'].invoke('chat.syssubscribe.GetNewMsg').then(function (data) {
	                ...
	                data.forEach(function (dataItem) {
	                    ...
	                    if (_this2.state.activeItem && _this2.state.activeItem.maintitle === maintitle) {
	                        _this2.state.activeItem.noQuit = false;
	                    }

	                    list.forEach(function (item) {
	                        if (item.maintitle === maintitle) {
	                            item.noQuit = false;
	                        }
	                    });
	                });
	                ...
	                !_this2.state.activeItem && _this2.setTitleActive(0);
	            });
	        }
	    }, {
	        key: 'setTitleActive',
	        value: function setTitleActive(index) {
	            ...
	            this.state.activeItem && (this.state.activeItem.active = false);
	            this.setState({
	                list: list,
	        ...
	        key: 'quitSubscribe',
	        value: function quitSubscribe(data) {
	            var list = this.state.list;

	            list.forEach(function (item) {
	                if (item.maintitle === data.maintitle) {
	                    item.noQuit = true;
	                }
	            });

	            this.state.activeItem.noQuit = true;
	        ...
	        value: function componentDidMount() {
	            ...
	            _aliImSdk2['default'].invoke('webpipe.RegisterWebControl', {
	                webName: 'WebName_SystemSubscription'
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                'div',
	                { className: 'sys-msg-page' },
	                _react2['default'].createElement(_sideTitleList2['default'], { list: this.state.list, clickHandler: this.setTitleActive.bind(this) }),
	                _react2['default'].createElement(_msgContent2['default'], _extends({}, this.state.activeItem, { quitSubscribe: this.quitSubscribe.bind(this) }))
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SideTitleList = (function (_React$Component) {
	    _inherits(SideTitleList, _React$Component);

	    function SideTitleList(props) {
	        _classCallCheck(this, SideTitleList);

	        _get(Object.getPrototypeOf(SideTitleList.prototype), 'constructor', this).call(this, props);
	        this.clickHandler = this.clickHandler.bind(this);
	    }

	    _createClass(SideTitleList, [{
	        key: 'clickHandler',
	        ...
	        key: 'goMessageBox',
	        value: function goMessageBox() {
	            _aliImSdk2['default'].invoke('webpipe.InvokeAnotherWeb', {
	        ...
	        value: function render() {
	            ...
	            this.props.list.forEach(function (item, index) {
	                list.push(_react2['default'].createElement(_title2['default'], _extends({ index: index, key: item.time + '' + index }, item, { clickHandler: _this.clickHandler })));
	            });
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'a',
	                        { href: 'javascript:;', className: 'more-btn', onClick: this.goMessageBox.bind(this) },
	                        'узнать больше'
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        ...
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement('img', {
	                                src: 'https://img.alicdn.com/tps/TB1l_txMXXXXXaTXFXXXXXXXXXX-280-280.png', width: '100%', alt: '' })
	                        ),
	                        _react2['default'].createElement(
	                            'div',
	                            { className: 'ad-text' },
	                            'Покупайте и продавайте связь в любое время и в любом месте'
	                        ),
	                        _react2['default'].createElement(
	                            'div',
	                            { className: 'ad-text' },
	    ...
	    return SideTitleList;
	})(_react2['default'].Component);

	exports['default'] = SideTitleList;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SideTitle = (function (_React$Component) {
	    _inherits(SideTitle, _React$Component);

	    function SideTitle() {
	        _classCallCheck(this, SideTitle);

	        _get(Object.getPrototypeOf(SideTitle.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(SideTitle, [{
	        key: 'clickHandler',
	        ...
	        key: 'render',
	        value: function render() {
	            var cls = (0, _classnames2['default'])('title-item', { read: this.props.isRead, active: this.props.active });
	            return _react2['default'].createElement(
	                'li',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MsgContent = (function (_React$Component) {
	    _inherits(MsgContent, _React$Component);

	    function MsgContent() {
	        _classCallCheck(this, MsgContent);

	        _get(Object.getPrototypeOf(MsgContent.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(MsgContent, [{
	        key: 'clickHandler',
	        value: function clickHandler() {
	            _aliImSdk2['default'].invoke('chat.syssubscribe.OpenSysSetting');
	        }
	    }, {
	        key: 'quitSubscribe',
	        value: function quitSubscribe() {
	            var _this = this;

	            _aliImSdk2['default'].invoke('chat.syssubscribe.QuitSubscribe', this.props).then(function () {
	                _this.props.quitSubscribe(_this.props);
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            //this.props.message = 'http://a.alibaba-inc.com/page/api/free/product/getnodeinfo.htm?_username=adrms'\"><iframe onload=alert()>';
	            return _react2['default'].createElement(
	                'div',
	                { className: 'msg-wrap' },
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'span',
	                        { className: 'msg-time' },
	                        this.props.time ? _$ROOTPMsgModUtil2['default'].timeFormatter(this.props.time) : ''
	                    ),
	                    !this.props.noQuit ? _react2['default'].createElement(
	                        'span',
	                        { className: 'msg-unsub' },
	                        _react2['default'].createElement(
	                            'a',
	                            { href: 'javascript:;', onClick: this.quitSubscribe.bind(this) },
	                            'Отписаться'
	                        )
	                    ) : null,
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement('i', { className: 'iconfont icon-seting', onClick: this.clickHandler })
	                    )
	                ),
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'msg-content' },
	                    _react2['default'].createElement('div', { dangerouslySetInnerHTML: { __html: this.props.message || this.props.content } })
	                ),
	                this.props.adUrl ? _react2['default'].createElement(
	                    'div',
	                    { className: 'ad-wrap' },
	                    _react2['default'].createElement('iframe', { src: this.props.adUrl, frameBorder: '0', width: '100%' })
	                ) : null
	            );
	        }
	    }]);
