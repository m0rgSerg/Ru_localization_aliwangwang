...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modIndex = __webpack_require__(174);
	...
	window.__WPO && __WPO.setConfig({
	    ...
	    sample: 500,
	    spmId: 'pcww9.0-login', // spmId必须设置,如果没写默认值，会自动抓页面的spm
	    retCode: {}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * 扫码登录
	 * 文档: http://baike.corp.taobao.com/index.php/%E4%BA%8C%E7%BB%B4%E7%A0%81%E7%99%BB%E5%BD%95
	 */
	'use strict';
	...
	var _qtcode = __webpack_require__(175);

	var _qtcode2 = _interopRequireDefault(_qtcode);
	    ...
	    _createClass(Index, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_qtcode2['default'], null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var path = /alires|alipkg/.test(location.protocol) ? '../' : '../../';

	var QTCode = (function (_React$Component) {
	    _inherits(QTCode, _React$Component);

	    function QTCode(props) {
	        _classCallCheck(this, QTCode);

	        _get(Object.getPrototypeOf(QTCode.prototype), 'constructor', this).call(this, props);

	        this.refreshQTCode = this.refreshQTCode.bind(this);
	        ...
	        this.TIP = {
	            ...
	            1: {
	                text: _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'a',
	                        { href: 'https://wangxin.taobao.com', target: '_blank', onClick: this.linkClickHander.bind(this, 'wx') },
	                        'Wangxin'
	                    ),
	                    'Отсканируйте QR-код, чтобы войти в систему.'
	                ),
	                btn: 'возвращаться'
	            },
	            2: {
	                text: _react2['default'].createElement(
	                    'span',
	                    null,
	                    'Срок действия QR-кода истек, нажмите',
	                    _react2['default'].createElement(
	                        'a',
	                        { href: 'javascript:;', onClick: this.refreshQTCode },
	                        "Обновить" 
	                    )
	                ),
	                btn: 'возвращаться'
	            ...
	            3: {
	                text: _react2['default'].createElement(
	                    'span',
	                    null,
	                    'Пожалуйста, нажмите, чтобы подтвердить логин на вашем телефоне'
	                ),
	                btn: 'отменить'
	            },
	            4: {
	                text: _react2['default'].createElement(
	                    'span',
	                    null,
	                    'Не удалось получить QR-код, нажмите',
	                    _react2['default'].createElement(
	                        'a',
	                        { href: 'javascript:;', onClick: this.refreshQTCode },
	                        'Обновить'
	    ...
	    _createClass(QTCode, [{
	        ...
	        value: function getQTCode() {
	            ...
	            _aliImSdk2['default'].ajax({
	                url: 'https://qrlogin.taobao.com/qrcodelogin/generateQRCode4Login.do',
	                param: {
	                    dsp: encodeURIComponent('Али Ванван'),
	                    from: 'aliwangwang'
	                },
	                apiKey: 'GET_QT_CODE',
	                validRule: function validRule(data) {
	                ...
	                if (!data || !data.success) {
	                    ...
	                    (0, _$ROOTCUtilLog2['default'])('wwxb.5.37');
	                    return;
	                }

	                _this.lgToken = data.lgToken;
	                _this.setState({
	                    status: 1,
	                    qtcode: data.url.indexOf('http') == 0 ? data.url : 'https:' + data.url
	                });

	                (0, _$ROOTCUtilLog2['default'])('wwxb.5.36');

	                _this.pullLoginResult();
	            })['catch'](function () {
	        ...
	        key: 'pullLoginResult',
	        value: function pullLoginResult() {
	            var _this2 = this;

	            if (this.stopPullLoginResult) return;
	            ...
	            this.pullTimeout = setTimeout(function () {
	                _aliImSdk2['default'].ajax({
	                    ...
	                    if (data.code == 10000) {
	                        // 开始扫码
	                        _this2.pullLoginResult();
	                    } else if (data.code == 10001) {
	                        // 手机扫码成功, 客户端切换提示用户点击登录的页面
	                        _this2.setState({
	                            status: 3
	                        });
	                        _this2.pullLoginResult();
	                    } else if (data.code == 10004 || data.code == 10002 || data.code == 10005) {
	                        // 二维码过期, 自动刷新三次, 三次后出手动刷新
	                        //if(this.refreshCount >= 3){
	                        _this2.setState({
	                            status: 2
	                        });
	                        if (data.code === 10004) {
	                            (0, _$ROOTCUtilLog2['default'])('wwxb.5.43');
	                        } else {
	                            (0, _$ROOTCUtilLog2['default'])('wwxb.5.42');
	                        }
	                        ...
	                        //}
	                            ...
	                            //alert('登录成功了, token是: ' + data.token + ', 上吧,皮卡丘!');
	                            _aliImSdk2['default'].invoke('login.StartQRLogin', {
	                                token: data.token,
	                                nick: data.nick
	                            });
	                            (0, _$ROOTCUtilLog2['default'])('wwxb.5.41');
	                        } else if (data.code == 10003) {
	                            // 取消登录
	                            _this2.btnClickHandler();
	                            (0, _$ROOTCUtilLog2['default'])('wwxb.5.44');
	                        }
	        ...
	        key: 'linkClickHander',
	        value: function linkClickHander(type, e) {
	            var logKey = ({ wx: 'wwxb.5.39', tao: 'wwxb.5.45' })[type];
	            (0, _$ROOTCUtilLog2['default'])(logKey);
	        }
	    }, {
	        key: 'refreshQTCode',
	        value: function refreshQTCode() {
	            this.setState({
	                status: 0
	            });
	            this.refreshCount++;
	            this.getQTCode();
	            (0, _$ROOTCUtilLog2['default'])('wwxb.5.38');
	        }
	    }, {
	        key: 'btnClickHandler',
	        value: function btnClickHandler() {
	            clearTimeout(this.pullTimeout);
	            this.stopPullLoginResult = true;
	            _aliImSdk2['default'].invoke('login.CancelQRLogin');
	            (0, _$ROOTCUtilLog2['default'])('wwxb.5.40');
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            var tip = this.TIP[status].text;
	            var btn = this.TIP[status].btn;
	            var tpl = null;

	            if (status == 0) {
	                tpl = _react2['default'].createElement('img', { src: path + "images/loading.gif", className: 'loading', alt: 'loading' });
	            } else if (status == 1) {
	                tpl = _react2['default'].createElement(
	                    'div',
	                    null,
	                    _react2['default'].createElement('img', { src: this.state.qtcode, className: 'qtcode-image', alt: 'QR-код для входа' }),
	                    _react2['default'].createElement('img', { src: path + "images/scan_tip.png", className: 'qt-scaner' })
	                );
	            } else if (status == 2) {
	                tpl = _react2['default'].createElement('img', { src: this.state.qtcode, className: 'qtcode-image-expired', onClick: this.refreshQTCode, alt: 'QR-код для входа' });
	            } else if (status == 3) {
	                tpl = _react2['default'].createElement(
	                    'div',
	                    null,
	                    _react2['default'].createElement('img', { src: path + "images/scan_success.gif", className: 'scan-succ-img', alt: '' }),
	                    _react2['default'].createElement(
	                        'p',
	                        { className: 'scan-succ-text' },
	                        'Отсканируйте код успешно'
	                    )
	                );
	            } else if (status == 4) {
	                tpl = _react2['default'].createElement('img', { src: path + "images/error-erweima.png", onClick: this.refreshQTCode, className: 'qtcode-image-error', alt: 'Ошибка QR-кода' });
	            }
