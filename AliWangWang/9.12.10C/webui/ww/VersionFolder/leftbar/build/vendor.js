...
/******/ 			script.src = __webpack_require__.p + "" + {"0":"364fac3a7e1619ea1da3"}[chunkId] + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(function(global, factory) {
	    ...
	    /**
	     * 取消监听事件
	     * @param   {String}      [name]            [По желанию]Название события, несколько названий событий разделяются символом или пробелом
	     * @param   {Function}    [callback]        [По желанию]Обратный вызов триггеров событий
	     * @param   {Boolean}     [canUnregister=true]      [По желанию]Можно ли отменить регистрацию событий самостоятельно, по умолчанию true
	     * @return  {Object}      SDK
	     * @example
	     * SDK.off();
